      ...
      <div className={`view${this.props.currentView === 'route' ? ' active' : ''}`} id='route-view'>
        <header className='view-header-top fixed-top row justify-content-md-center'>
          ...
          <div className='route-options'>
            {this.state.messages.length > 0 && 
              <button style={{ color: '#ddd' }} className='route-info btn' id='toggleInfoBox' aria-label='Messages Button' onClick={
                () => {
                  document.querySelector('#route-info-box').classList.toggle('shown');
                }
              }>
                <svg style={{ color: '#ddd' }} xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' className='bi bi-info-circle-fill' viewBox='0 0 16 16'>
                  <path
                    style={{ color: '#ddd' }}
                    fillRule='evenodd' d='M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412l-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588zM8 5.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2z'/>
                </svg>
              </button>
            }
          </div>
        ...
        <div id='route-info-box' className='route-info-box modal route-modal'>
          <div className='route-header'>
            <button onClick={() => this.props?.returnHome()} className='col-auto btn' aria-label='Return Button' style={{ position: 'absolute', left: 0, padding: '1rem' }}>
